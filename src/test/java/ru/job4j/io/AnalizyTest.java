...
public class AnalizyTest {
    ...
    @Test
    public void testServerLogsUnavailable1() throws IOException {
    ...
    @Test
    public void testServerLogsUnavailable2() throws IOException {
        File source = folder.newFile("source.txt");
        File target = folder.newFile("target.txt");
        try (PrintWriter out = new PrintWriter(source)) {
            out.println("200 10:56:01");
    ...
    @Test
    public void testServerLogsUnavailable3() throws IOException {
        File source = folder.newFile("source.txt");
        File target = folder.newFile("target.txt");
        try (PrintWriter out = new PrintWriter(source)) {
            out.println("200 10:56:01");
            ...
            out.println("400 11:05:02");
            out.println("400 11:06:02");
            out.println("500 11:07:02");
            out.println("400 11:08:02");
            out.println("100 11:09:20");
        }
        Analizy analizy = new Analizy();
        analizy.unavailable(source.getAbsolutePath(), target.getAbsolutePath());
        StringBuilder rsl = new StringBuilder();
