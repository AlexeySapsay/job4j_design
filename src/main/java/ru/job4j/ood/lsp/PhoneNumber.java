...
class ThirdRule {
    public static void main(String[] args) {
        ...
        System.out.println("subscriber number with validation: " + subscriber.getPhoneNumber());
        subscriber.setPhoneNumber(
                new PhoneNumber(-1, 111, 111_111_111)
        );
        System.out.println("subscriber number without validation in setter: " + subscriber.getPhoneNumber());
    }
}